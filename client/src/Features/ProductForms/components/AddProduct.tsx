  ...
  return (
    <div className='center-container addProduct-container'>
      <form className='addProduct-container__form' onSubmit={handleSubmit(productPost)}>
        <input className='input-form' type="text" placeholder='Название' {...register('title')} />
        <span>{errors.title?.message}</span>
        <input className='input-form' type="text" placeholder='Описание' {...register('description')} />
